...
- Hardware is the physical components that make up a PC
...
File systems is a process that manages how and where data on a storage disk is stored, accessed and managed.
